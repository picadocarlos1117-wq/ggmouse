...
public final class GCMParameters extends AlgorithmParametersSpi {
    ...
    public byte[] engineGetEncoded() throws Throwable {
        ...
        try {
            ...
            try {
                ...
                NativeCrypto.asn1_write_octetstring(jAsn1_write_sequence, this.f8442iv);
                int i = this.tLen;
                if (i != DEFAULT_TLEN) {
    ...
    public <T extends AlgorithmParameterSpec> T engineGetParameterSpec(Class<T> cls) throws InvalidParameterSpecException {
        if (cls != null && cls.getName().equals("javax.crypto.spec.GCMParameterSpec")) {
            return cls.cast(Platform.toGCMParameterSpec(this.tLen, this.f8442iv));
        }
    ...
    public void engineInit(byte[] bArr) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                this.f8442iv = bArrAsn1_read_octetstring;
    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
        ...
        if (gCMParametersFromGCMParameterSpec != null) {
            ...
            this.f8442iv = gCMParametersFromGCMParameterSpec.f8442iv;
            return;
        }
