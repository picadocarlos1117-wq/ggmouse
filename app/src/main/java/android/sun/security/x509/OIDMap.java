    ...
    public static void addAttribute(String str, String str2, Class cls) throws CertificateException {
        try {
            ...
            if (oidMap.put(objectIdentifier, oIDInfo) != null) {
                throw new CertificateException(AbstractC1308pu.m5339f("Object identifier already exists: ", str2));
            }
            if (nameMap.put(str, oIDInfo) != null) {
                throw new CertificateException(AbstractC1308pu.m5339f("Name already exists: ", str));
            }
        } catch (IOException unused) {
            throw new CertificateException(AbstractC1308pu.m5339f("Invalid Object identifier: ", str2));
        }
    }
