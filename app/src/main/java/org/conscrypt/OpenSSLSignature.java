...
public class OpenSSLSignature extends SignatureSpi {
    ...
    /* JADX INFO: renamed from: org.conscrypt.OpenSSLSignature$1 */
    /* JADX INFO: compiled from: r8-map-id-111b6a80b616d31e8b9d8e722d2d8cc99d6979087cf6e6d25de4f2652b3eb537 */
    public static /* synthetic */ class C12601 {
    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if (!"MGF1".equalsIgnoreCase(mGFAlgorithm) && !"1.2.840.113549.1.1.8".equals(mGFAlgorithm)) {
                throw new InvalidAlgorithmParameterException(jd0.m3615m("Unsupported MGF algorithm: ", mGFAlgorithm, ". Only MGF1 supported"));
            }
            ...
            try {
                ...
                if (saltLength < 0) {
                    throw new InvalidAlgorithmParameterException(jd0.m3609g(saltLength, "Salt length must be non-negative: "));
                }
                int trailerField = pSSParameterSpec.getTrailerField();
                if (trailerField != 1) {
                    throw new InvalidAlgorithmParameterException(jd0.m3610h(trailerField, "Unsupported trailer field: ", ". Only 1 supported"));
                }
    ...
    private void checkEngineType(OpenSSLKey openSSLKey) throws InvalidKeyException {
        ...
        int i = C12601.$SwitchMap$org$conscrypt$OpenSSLSignature$EngineType[this.engineType.ordinal()];
        if (i == 1) {
            if (iEVP_PKEY_type == 6) {
                return;
            }
    ...
    public byte[] engineSign() {
        try {
            ...
            f40.m2711g("Reset of context failed after it was successful once");
            return null;
        }
    }
    ...
    public void engineUpdate(ByteBuffer byteBuffer) {
        if (byteBuffer.hasRemaining()) {
            ...
            if (iPosition < 0) {
                l41.m4048q("Negative position");
                return;
            }
            long j = directBufferAddress + ((long) iPosition);
            int iRemaining = byteBuffer.remaining();
            if (iRemaining < 0) {
                l41.m4048q("Negative remaining amount");
                return;
            }
    ...
    public /* synthetic */ OpenSSLSignature(long j, EngineType engineType, C12601 c12601) {
        this(j, engineType);
    }
