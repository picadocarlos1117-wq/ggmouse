...
@InterfaceC1311px(m5372c = "com.example.ssmousepro.account.AccountRepository$carregarPerfil$server$1", m5373f = "AccountRepository.kt", m5374l = {97}, m5375m = "invokeSuspend")
public final class AccountRepository$carregarPerfil$server$1 extends ny1 implements ch0 {
    final /* synthetic */ DocumentReference $docRef;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountRepository$carregarPerfil$server$1(DocumentReference documentReference, InterfaceC0579du interfaceC0579du) {
    ...
    public final InterfaceC0579du create(Object obj, InterfaceC0579du interfaceC0579du) {
        return new AccountRepository$carregarPerfil$server$1(this.$docRef, interfaceC0579du);
    }

    @Override // p000.ch0
    public final Object invoke(CoroutineScope coroutineScope, InterfaceC0579du interfaceC0579du) {
        return ((AccountRepository$carregarPerfil$server$1) create(coroutineScope, interfaceC0579du)).invokeSuspend(z32.f13265a);
    }
