...
final class SSLUtils {
    ...
    public static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            if (b < 0 || b > bArr.length - i2) {
                StringBuilder sbM5345l = AbstractC1308pu.m5345l("Protocol has invalid length (", b, " at position ", i2, "): ");
                sbM5345l.append(bArr.length < 50 ? Arrays.toString(bArr) : AbstractC1308pu.m5341h(new StringBuilder(), bArr.length, " byte array"));
    ...
    public static byte[] encodeProtocols(String[] strArr) {
        if (strArr == null) {
            f40.m2713i("protocols array must be non-null");
            return null;
        }
        if (strArr.length == 0) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            ...
            if (str == null) {
                f40.m2713i(jd0.m3610h(i2, "protocol[", "] is null"));
                return null;
            }
            int length = str.length();
            if (length == 0 || length > MAX_PROTOCOL_LENGTH) {
                f40.m2713i(AbstractC1308pu.m5338e("protocol[", i2, length, "] has invalid length: "));
                return null;
            }
            i += length + 1;
        }
