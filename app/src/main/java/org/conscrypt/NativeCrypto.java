...
public final class NativeCrypto {
    ...
    static {
        ...
        if (e == null) {
            ...
            if (length % 2 != 0) {
                f40.m2713i("Invalid cipher list returned by get_cipher_names");
                return;
            }
            int i = length / 2;
    ...
    public static String[] checkEnabledCipherSuites(String[] strArr) {
        if (strArr == null) {
            f40.m2713i("cipherSuites == null");
            return null;
        }
        for (int i = 0; i < strArr.length; i++) {
            String str = strArr[i];
            if (str == null) {
                f40.m2713i(jd0.m3610h(i, "cipherSuites[", "] == null"));
                return null;
            }
            if (!str.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !strArr[i].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i])) {
                f40.m2713i(AbstractC1308pu.m5342i(new StringBuilder("cipherSuite "), strArr[i], " is not supported."));
                return null;
            }
        }
        return strArr;
    ...
    public static String[] checkEnabledProtocols(String[] strArr) {
        if (strArr == null) {
            f40.m2713i("protocols == null");
            return null;
        }
        for (String str : strArr) {
            if (str == null) {
                f40.m2713i("protocols contains null");
                return null;
            }
            if (!str.equals(SUPPORTED_PROTOCOL_TLSV1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !str.equals(OBSOLETE_PROTOCOL_SSLV3)) {
                f40.m2713i(jd0.m3615m("protocol ", str, " is not supported"));
                return null;
            }
        }
        return strArr;
    ...
    private static int getProtocolConstant(String str) {
        ...
        f40.m2711g("Unknown protocol encountered: ".concat(str));
        return 0;
    }
    ...
    private static Range getProtocolRange(String[] strArr) {
        ...
        f40.m2713i("No protocols enabled.");
        return null;
    }
