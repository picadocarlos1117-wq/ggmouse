...
public final class xn0 extends fi0 implements z41 {
    private static final xn0 DEFAULT_INSTANCE;
    ...
    static {
        xn0 xn0Var = new xn0();
        DEFAULT_INSTANCE = xn0Var;
        fi0.registerDefaultInstance(xn0.class, xn0Var);
    }
