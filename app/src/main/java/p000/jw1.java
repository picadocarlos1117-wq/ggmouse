...
public final class jw1 extends fi0 implements z41 {
    private static final jw1 DEFAULT_INSTANCE;
    ...
    static {
        jw1 jw1Var = new jw1();
        DEFAULT_INSTANCE = jw1Var;
        fi0.registerDefaultInstance(jw1.class, jw1Var);
    }

    /* JADX INFO: renamed from: f */
    public static void m3715f(jw1 jw1Var, cx1 cx1Var) {
        jw1Var.getClass();
        cx1Var.getClass();
        jw1Var.field_ = cx1Var;
        jw1Var.bitField0_ |= 1;
    }

    /* JADX INFO: renamed from: g */
    public static iw1 m3716g() {
