...
public class IssuerAlternativeNameExtension extends Extension implements CertAttrSet<String> {
    ...
    public void delete(String str) throws IOException {
        if (!str.equalsIgnoreCase(ISSUER_NAME)) {
            ca0.m1178j("Attribute name not recognized by CertAttrSet:IssuerAlternativeName.");
        } else {
            this.names = null;
            encodeThis();
        }
    ...
    public Enumeration<String> getElements() {
        return AbstractC1308pu.m5348o(ISSUER_NAME);
    }
    ...
    public String toString() {
        String strConcat;
        String strM5342i = AbstractC1308pu.m5342i(new StringBuilder(), super.toString(), "IssuerAlternativeName [\n");
        GeneralNames generalNames = this.names;
