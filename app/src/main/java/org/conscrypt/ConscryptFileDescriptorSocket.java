...
class ConscryptFileDescriptorSocket extends OpenSSLSocketImpl implements NativeCrypto.SSLHandshakeCallbacks, SSLParametersImpl.PSKCallbacks, SSLParametersImpl.AliasChooser {
    ...
    private SSLInputStream f8440is;

    /* JADX INFO: renamed from: os */
    private SSLOutputStream f8441os;
    ...
    public final void close() throws IOException {
        ...
        synchronized (nativeSsl) {
            try {
                ...
                this.ssl.notifyAll();
                SSLInputStream sSLInputStream = this.f8440is;
                SSLOutputStream sSLOutputStream = this.f8441os;
    ...
    public final InputStream getInputStream() throws SocketException {
        ...
        synchronized (this.ssl) {
            try {
                ...
                if (this.f8440is == null) {
                    this.f8440is = new SSLInputStream();
                }
                sSLInputStream = this.f8440is;
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final OutputStream getOutputStream() throws SocketException {
        ...
        synchronized (this.ssl) {
            try {
                ...
                if (this.f8441os == null) {
                    this.f8441os = new SSLOutputStream();
                }
                sSLOutputStream = this.f8441os;
            } catch (Throwable th) {
                throw th;
            }
        }
