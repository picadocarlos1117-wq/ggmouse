...
class ConscryptEngineSocket extends OpenSSLSocketImpl implements SSLParametersImpl.AliasChooser {
    ...
    private SSLInputStream f8439in;
    private SSLOutputStream out;
    private int state;
    private final Object stateLock;

    /* JADX INFO: renamed from: org.conscrypt.ConscryptEngineSocket$3 */
    /* JADX INFO: compiled from: r8-map-id-111b6a80b616d31e8b9d8e722d2d8cc99d6979087cf6e6d25de4f2652b3eb537 */
    public static /* synthetic */ class C12453 {
    ...
    public void doHandshake() throws IOException {
        ...
        while (!z) {
            try {
                int i = C12453.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[this.engine.getHandshakeStatus().ordinal()];
                if (i != 1) {
                    if (i == 2) {
                ...
                } else if (this.f8439in.processDataFromSocket(EmptyArray.BYTE, 0, 0) < 0) {
        ...
        synchronized (obj) {
            try {
                ...
                try {
                    ...
                    try {
                        super.close();
                        if (this.f8439in != null) {
                        }
                    } finally {
                        if (this.f8439in != null) {
                            this.f8439in.release();
                        }
                    }
                } catch (Throwable th) {
                    try {
            ...
            synchronized (this.handshakeLock) {
                synchronized (this.stateLock) {
                    if (this.state == 0) {
                        ...
                        this.f8439in = new SSLInputStream();
    ...
    public final class SSLInputStream extends InputStream {
        ...
        private boolean isHandshaking(SSLEngineResult.HandshakeStatus handshakeStatus) {
            int i = C12453.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus.ordinal()];
            return i == 1 || i == 2 || i == 3;
        }
        ...
        public int processDataFromSocket(byte[] bArr, int i, int i2) throws SocketException, SSLException {
            ...
            while (this.fromEngine.remaining() <= 0) {
                ...
                this.fromEngine.flip();
                int i3 = C12453.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultUnwrap.getStatus().ordinal()];
                boolean z = true;
                if (i3 == 1) {
