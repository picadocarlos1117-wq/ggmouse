...
public final class p90 implements Interpolator {
    ...
    public p90(float[] fArr) {
        this.f8815a = fArr;
        this.f8816b = 1.0f / (fArr.length - 1);
    }
}
