...
@InterfaceC1311px(m5372c = "com.example.ssmousepro.FloatingService$restaurarOverridesTelaVerificado$2$okRes$1", m5373f = "FloatingService.kt", m5374l = {6340}, m5375m = "invokeSuspend")
public final class FloatingService$restaurarOverridesTelaVerificado$2$okRes$1 extends ny1 implements og0 {
    int label;
    final /* synthetic */ FloatingService this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FloatingService$restaurarOverridesTelaVerificado$2$okRes$1(FloatingService floatingService, InterfaceC0579du interfaceC0579du) {
    ...
    public final InterfaceC0579du create(InterfaceC0579du interfaceC0579du) {
        return new FloatingService$restaurarOverridesTelaVerificado$2$okRes$1(this.this$0, interfaceC0579du);
    }

    @Override // p000.og0
    public final Object invoke(InterfaceC0579du interfaceC0579du) {
        return ((FloatingService$restaurarOverridesTelaVerificado$2$okRes$1) create(interfaceC0579du)).invokeSuspend(z32.f13265a);
    }
