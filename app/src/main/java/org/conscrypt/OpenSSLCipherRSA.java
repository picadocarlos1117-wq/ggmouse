...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalBlockSizeException {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(AbstractC1308pu.m5341h(new StringBuilder("input must be under "), this.buffer.length, " bytes"));
        }
    ...
    public int engineGetKeySize(Key key) throws InvalidKeyException {
        ...
        if (key == null) {
            l41.m4039h("RSA private or public key is null");
            return 0;
        }
        l41.m4039h("Need RSA private or public key");
        return 0;
    }
    ...
    public int keySizeBytes() {
        ...
        f40.m2719o("cipher is not initialized");
        return 0;
    }
    ...
    public static class OAEP extends OpenSSLCipherRSA {
        ...
        public AlgorithmParameters engineGetParameters() {
            ...
            try {
                ...
                l41.m4048q("No providers of AlgorithmParameters.OAEP available");
                return null;
            }
        }
        ...
        public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
            if (i == 1 || i == 3) {
                if (!(key instanceof PublicKey)) {
                    l41.m4039h("Only public keys may be used to encrypt");
                    return;
                }
            } else if ((i == 2 || i == 4) && !(key instanceof PrivateKey)) {
                l41.m4039h("Only private keys may be used to decrypt");
                return;
            }
